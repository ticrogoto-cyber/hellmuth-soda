...
def render_all():
    ...
    render_rule_card(
        "Hinweis",
        [
            "Dieses Kartenspiel ist für Erwachsene.",
            "Es dient der Selbstreflexion und Gesprächsanregung.",
            "Es ist kein medizinisches, psychotherapeutisches oder",
            "suchttherapeutisches Produkt.",
            "Bei akuten psychischen oder körperlichen Beschwerden",
