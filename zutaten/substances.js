...
window.SUBSTANCES_DATA = {
  entries: [
    ...
    },
    {
      ...
      wirkung: "Chlorella wird als Detox-Algen vermarktet mit dem Versprechen, Schwermetalle wie Quecksilber und Blei aus dem Körper zu eliminieren, eine Behauptung, die auf In-vitro-Bindungsstudien beruht und am Menschen nur in einer einzigen kleinen Studie zu Quecksilber-Ausleitung dokumentiert ist.\n\nDas eigentliche pharmakologische Problem ist umgekehrt, weil Chlorella als Mikroalge an ihrem Wachstumssubstrat mit Schwermetallen kontaminiert sein kann, was in unabhängigen Marktanalysen regelmäßig in Produkten ohne GMP-Zertifizierung nachgewiesen wurde.\n\nHinzu kommt ein Toxinrisiko, weil Co-Kulturen mit Cyanobakterien Mikrozystine und das neurotoxische BMAA enthalten können, ein Befund, der die Detox-Werbung nicht selten in den umgekehrten klinischen Befund überführt. Der häufig zitierte Vitamin-B12-Gehalt ist überdies pharmakologisch wertlos, weil es sich um inaktive Cobamide handelt, die am menschlichen B12-Rezeptor nicht binden und die Aufnahme echten Cobalamins in einigen Fällen kompetitiv hemmen.\n\nEine Alge, die als Detox-Mittel vermarktet wird, ist im klinischen Befund vor allem ein Kontaminationsrisiko, und das beworbene B12 darin ist biochemisch nicht aktiv.",
    ...
    },
    {
      ...
      wirkung: "DMSO hemmt Entzündungen, verstärkt die Penetration anderer Wirkstoffe durch die Haut, schützt Nervengewebe und bewahrt Organe nach Ischämie vor dem Absterben. Die FDA hat das Molekül 1978 für interstitielle Zystitis zugelassen und seitdem nie erweitert, obwohl die Datenlage für Dutzende weitere Indikationen vorliegt. Das pharmakologische Standardwerk fasst die Befunde zusammen, ohne dass ein einziger Leitlinienausschuss reagiert. Eine Substanz, die als irreversibel geltende Lähmungen rückgängig macht, wird im Drogeriemarkt geführt und in der Klinik konsequent ignoriert.\n\nAls Lösungsmittel löst DMSO pflanzliche Wirkstoffe mindestens so gut wie Ethanol, durchquert dabei die Blut-Hirn-Schranke und hebt die Bioverfügbarkeit der gelösten Stoffe deutlich an. Die gesamte Schwedenbitter-Tradition, die gesamte alkoholische Phytotherapie ließe sich auf DMSO umstellen, ohne Alkoholschaden, mit besserer Penetration ins Gewebe. Dass kein Hersteller diesen Schritt vollzieht, ist Marktstruktur.\n\nWer einen Extrakt verkauft, dessen Wirkstoffe tatsächlich ankommen, untergräbt das Geschäftsmodell der Verdünnung. Das wirksamere Extraktionsmedium der gesamten Pflanzenheilkunde liegt seit Jahrzehnten in jedem Regal und wird konsequent übersehen.\n\nIn Deutschland ist DMSO frei verkäuflich, billig und nicht patentierbar. Wer es medizinisch anwendet, verschweigt es dem Arzt, weil der sonst aufhört zuzuhören. Auf der Haut entsteht nach wenigen Minuten eine knoblauchartige Wärme im Mund, der Körper meldet die systemische Verteilung in Echtzeit. Die Substanz ist erlaubt, aber unsagbar. Unterdrückung läuft hier über soziale Ächtung und fehlende Erstattung. Kein Arzt zahlt mit DMSO seine Hypothek ab.\n\nDas Paradebeispiel einer wirksamen Substanz, die ohne Verbot aus dem klinischen Alltag verschwunden ist.",
      quellen: ["Jacob/de la Torre 2015", "Jacob/Herschler 1986"],
