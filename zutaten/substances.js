...
window.SUBSTANCES_DATA = {
  entries: [
    ...
    },
    {
      ...
      wirkung: "Cannabidiol wirkt nicht über CB1-Rezeptoren und macht nicht high. Damit endet, was an der CBD-Erzählung stimmt und gleichzeitig relevant ist. Alles andere ist eine Frage der Dosis, und die Dosis ist das Problem.\n\nAls Epidiolex ist CBD als Arzneimittel gegen therapieresistente Epilepsie zugelassen, bei Dravet- und Lennox-Gastaut-Syndrom. Die wirksame Dosis liegt bei zehn bis zwanzig Milligramm pro Kilogramm Körpergewicht. Für einen siebzig Kilogramm schweren Erwachsenen sind das 700 bis 1400 mg täglich. In dieser Dosis reduziert CBD Anfälle um vierzig Prozent. In dieser Dosis verursacht es auch Leberschäden, Durchfall und Sedierung, weshalb es verschreibungspflichtig ist und Leberwerte kontrolliert werden müssen.\n\nDie Tropfen im Reformhaus enthalten zehn bis fünfzig Milligramm. Das ist fünfzig- bis hundertfach weniger als die Arzneimitteldosis. Die einzige Humanstudie, die eine anxiolytische Wirkung zeigt, verwendete 300 mg als Einzeldosis vor einem simulierten öffentlichen Redeauftritt. Dreihundert Milligramm, nicht zehn. Die Studie wird auf jeder CBD-Produktseite zitiert, die Dosis nie.\n\nDie FDA hat zwischen 2015 und 2023 über 120 CBD-Produkte getestet. Mehr als die Hälfte enthielten weniger CBD als deklariert. Einige enthielten THC über dem Grenzwert. Einige enthielten kein CBD. Die Qualitätskontrolle in einem unregulierten Markt funktioniert nicht, weil sie nicht funktionieren muss.\n\nIn der EU ist CBD als Novel Food eingestuft. Die meisten Produkte im Handel haben keine Novel-Food-Zulassung. Sie werden trotzdem verkauft, weil die Durchsetzung stockt und der Markt schneller wächst als die Behörden reagieren.\n\nEine Milliarden-Industrie, gebaut auf einer Epilepsie-Studie, die niemand liest, in Dosen, die niemand verkauft, mit Produkten, die niemand prüft.",
      quellen: ["Devinsky 2017", "Zuardi 2017", "Bonn-Miller 2017", "FDA CBD Marketplace 2023"],
      related_article: null,
      featured: false,
    },
    {
