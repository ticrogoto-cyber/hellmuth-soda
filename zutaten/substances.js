  ...
  entries: [
    {
      ...
      wirkung: "Akazienfaser fermentiert langsamer als Inulin. Das ist der Punkt. Inulin explodiert im rechten Dickdarm und produziert Gas, Akazienfaser verteilt sich über die gesamte Kolonlänge, kein Blähbauch, trotzdem Präbiotik.\n\nVier Wochen täglich zehn Gramm erhöhen Bifidobakterien und Laktobazillen signifikant, bei besserer Verträglichkeit als Inulin. Anwendung bei Reizdarm, Antibiotika-Durchfall und chronischer Verstopfung. Die langsame Fermentation verteilt die Gasproduktion über den gesamten Kolonverlauf, statt sie an einer Stelle konzentriert auszulösen.\n\nEine Faser, die wirkt wie Inulin und sich anfühlt wie Reis. Deshalb kennt sie niemand.",
    ...
    },
    {
      ...
      wirkung: "Erst 2004 isoliert vom niederländischen Mikrobiologen Antoon Akkermans. Die Spezies lebt in der inneren Schleimschicht des Darms und frisst ausschließlich Mucin, also in direktem Kontakt zur Darmbarriere.\n\nNiedrige Akkermansia-Abundanz korreliert mit Adipositas, Typ-2-Diabetes und Lebersteatose. Eine Phase-II-Studie an Übergewichtigen mit metabolischem Syndrom zeigt, dass drei Monate pasteurisierte Akkermansia Leberenzyme senken, die Insulinsensitivität verbessern und LDL reduzieren. Die pasteurisierte Form wirkt stärker als die lebende, ein Befund, der die Probiotikum-Logik umkehrt.\n\nEine 2004 entdeckte Mucin-Spezialistin liefert als Totpräparat, was Metformin in kleiner Dosis schafft.",
    ...
    },
    {
      ...
      wirkung: "Aktivkohle ist ein Notfallmedikament. Ein Gramm pro Kilogramm Körpergewicht, innerhalb einer Stunde nach Giftaufnahme. Dann bindet sie das Gift. Danach nicht mehr.\n\nDie Adsorptionsoberfläche unterscheidet nicht. Sie bindet alles, Vitamine, Mineralien, Medikamente, Hormone, auch die Pille. Reduzierte Wirksamkeit von Levothyroxin, Antidepressiva, Gerinnungshemmern und oralen Kontrazeptiva ist dokumentiert. Ein Fallbericht beschreibt eine ungewollte Schwangerschaft nach Charcoal-Smoothie unter Pilleneinnahme. Eine kontrollierte Studie zur Detox-Wirkung existiert nicht, das Konzept hat keine pharmakologische Basis.\n\nAktivkohle gehört in die Notaufnahme. Der Smoothie kennt keine Indikation. Die Adsorptionsfläche unterscheidet nicht zwischen Toxin und Vitamin.",
    ...
    },
    {
      ...
      wirkung: "Aloe enthält über zweihundert bioaktive Verbindungen. Der Hauptwirkstoff heißt Acemannan und aktiviert dendritische Zellen.\n\nVier Wochen oral bei aktiver Colitis ulcerosa zeigen signifikante Remission gegenüber Placebo, beschleunigte Heilung bei Aphthen, erhöhte Bioverfügbarkeit von Vitamin C und E bei gleichzeitiger Einnahme und topisch beschleunigte Wundheilung bei Verbrennungen. Die äußere Blattschicht enthält Aloin, genotoxisch, seit 2013 als IARC-Karzinogen Gruppe 2B eingestuft.\n\nDer Wert von Aloe hängt vollständig daran, dass inneres Gel und Ganzblattextrakt nicht dasselbe sind.",
    ...
    },
    {
      ...
      wirkung: "Anthocyane sind die Farbstoffe der dunklen Beeren. Sie wirken am Endothel über NO-Aktivierung, in der Mikroglia über NF-κB-Hemmung und am Auge über Photorezeptor-Stabilisierung. Aronia-Saft senkt den systolischen Blutdruck bei moderater Hypertonie über zwölf Wochen. Das ist Pharmakologie aus dem Strauch.\n\nSauerkirsche enthält andere Anthocyane mit eigener Wirkung. Tart-Cherry-Saft am Abend verbessert die Schlafqualität bei Insomnie über Melatonin-Erhöhung. Die Pharmakologie ist sortenabhängig, das Marketing der Antioxidans-Kapsel arbeitet sortenblind.\n\nBioverfügbarkeit ist niedrig, klinische Effekte trotzdem messbar, weil Anthocyane bereits in geringer Plasmakonzentration über Sirtuin-Signale arbeiten. Wer Anthocyane will, isst die Beere. Das Extrakt-Pulver liefert sie im selben Kontext nicht.\n\nDie Frucht trägt mehr, als jeder Pulversack ausweisen kann.",
    ...
    },
    {
      ...
      wirkung: "Apigenin hemmt CD38, das Enzym, das NAD+ verbraucht. Weniger CD38-Aktivität bedeutet mehr NAD+ in der Zelle, ohne externe Vorläufer wie NMN oder NR. Das unterscheidet Apigenin von allen anderen Polyphenolen, es spart NAD+, statt es zu liefern.\n\nDaneben wirkt die Substanz antiinflammatorisch über NF-κB-Hemmung, anxiolytisch über GABA-A-Modulation und antitumoral über mehrere Apoptose-Pfade. Klinische Endpunktdaten am Menschen sind selten, weil die Substanz erst seit wenigen Jahren isoliert verkauft wird. Die höchste Apigenin-Konzentration der Lebensmittelwelt findet sich in Petersilie mit 215 Milligramm pro 100 Gramm frisch.\n\nWer Apigenin im Longevity-Regal für dreißig Euro pro Kapsel kauft, übersieht den Tellerrand.",
    ...
    },
    {
      ...
      wirkung: "Die Spore überlebt Magensäure, Antibiotika und Backofen.\n\nBei Reizdarm reduziert der Stamm GBI-30 Schmerzen und Blähungen über acht Wochen.\n\nMan kann ihn parallel zum Antibiotikum nehmen, ohne dass er stirbt.",
      quellen: [],
      related_article: null,
    },
    {
      ...
      wirkung: "»Soil-based« klingt nach Urzeit-Weisheit und bedeutet im Klartext aus dem Dreck.\n\nNur zwei Stämme der Spezies haben Humandaten, der Rest ist Marketing mit Erde drauf. Wer Natto isst, bekommt Vitamin K2 als Bonus, weil der Bakterienstamm im Fermentationsprozess der Sojabohne K2 in hoher Konzentration produziert.\n\nWer Kapseln schluckt, bekommt einen Stamm-Code oder ein Fragezeichen.",
      quellen: [],
      related_article: null,
    },
    {
    ...
    },
    {
      ...
      wirkung: "Chlorophyll ist der molekulare Zwilling von Hämoglobin mit identischer Porphyrinring-Struktur und Magnesium im Zentrum statt Eisen. JAMA publizierte Arbeiten zur Blutregeneration durch Chlorophyll bereits in den 1930er Jahren. Eine Tierstudie (PMC 2023) mit Chlorophyll-Injektion bei Ratten zeigt signifikante Erhöhung von Erythrozyten, Leukozyten, Hämoglobin, Hämatokrit und Thrombozyten. Weizengras als chlorophyllreiche Pflanze reduzierte in einer pädiatrischen Studie den Transfusionsbedarf bei Thalassämie-Patienten substantiell.\n\nIm chinesischen Arzneibuch arbeitet Shengxuening als Natrium-Eisen-Chlorophyllin (Magnesium durch Eisen ersetzt) bei verschiedenen Anämieformen mit dokumentiertem klinischem Erfolg. Die Substanz stimuliert die Erythropoiese im Knochenmark direkt und reduziert die Rouleaux-Formation in der peripheren Mikrozirkulation. Das Blut fließt freier, der Sauerstofftransport steigt.\n\nZusätzlich bindet Chlorophyll Schwermetalle und Karzinogene im Darmlumen und unterstützt die Leberfiltration über Phase-2-Enzyme.\n\nDie Substanz wirkt antiinflammatorisch und neuroprotektiv.\n\nWerbung verkauft grünen Instagram-Drink, Detox-Tropfen und Superfood-Wasser, während im Körper ein Blutbildner arbeitet.",
    ...
    },
    {
      ...
      quellen: ["Morck 1983", "Rapuri 2007", "Hurrell 1999", "Camaschella 2015"],
      related_article: null,
    },
    {
    ...
    },
    {
      ...
      wirkung: "Anethol aus Fenchel und Anis plus Carvon aus Kümmel sind Karminativa. Das bedeutet, sie lösen verkrampfte glatte Muskulatur im Gastrointestinaltrakt und treiben Gas aus. Der Mechanismus läuft über TRPM8- und TRPA1-Ionenkanäle, dieselben, die Menthol und Capsaicin aktivieren.\n\nIn der Pädiatrie ist die Kombination seit Jahrzehnten erste Wahl bei Säuglingskoliken. Eine kontrollierte Studie zeigt nach Fenchel-Tee signifikante Reduktion der Koliken-Dauer. Bei Erwachsenen dokumentiert eine Studie mit Kümmelöl-Kapseln signifikante Symptomverbesserung bei funktioneller Dyspepsie, vergleichbar mit Cisaprid.\n\nDie Pharmakologie ist solide und alt. Das Problem ist, dass solide und alt in der Supplement-Industrie nicht verkaufbar ist. Die drei Pflanzen stehen im Babyregal, nicht im Apothekenschrank.\n\nDrei Karminativa, die in der Pädiatrie funktionieren und in der Erwachsenenmedizin vergessen wurden.",
    ...
    },
    {
      ...
      wirkung: "GOS senkt die Cortisol-Aufwachreaktion nach drei Wochen. Messbar, Bei Säuglingen halbiert es Hautekzeme und Darminfekte.\n\nWeniger Gas als Inulin, bessere Verträglichkeit.",
      quellen: [],
      related_article: null,
    },
    {
    ...
    },
    {
      ...
      wirkung: "Hopfen ist in der europäischen Heilpflanzentradition ein Nervinum, in der Pharmakologie eine Mehrkomponentenpflanze und in der Werbung nur ein Schlaftee. Humulon und die Iso-α-Säuren modulieren GABA-A-Rezeptoren positiv, eine placebokontrollierte Studie an gesunden Erwachsenen senkt unter Hopfen-Trockenextrakt Angst-, Depressions- und Stress-Scores in allen drei DASS-21-Skalen. Xanthohumol, das prenylierte Chalcon der Lupulindrüsen, induziert Nrf2 und hemmt NF-κB, eine anti-inflammatorische Achse jenseits jedes Schlafkontextes.\n\nDie Bitterstoffe sprechen TAS2R-Rezeptoren an und ziehen über das enteroendokrine System Ghrelin- und CCK-Signale nach, eine eigene Wirkachse.\n\nDass die Monotherapie-Evidenz dünn aussieht, sagt mehr über die Forschungsfrage als über die Pflanze.\n\nMan hat ein Sedativum gesucht und eine Apotheke übersehen.",
    ...
    },
    {
      ...
      wirkung: "Inulin füttert Bifidobakterien. Das stimmt.\n\nEs produziert dabei Gas, Blähungen und Krämpfe bei jedem, dessen Darm ohnehin schon gereizt ist. Wer Reizdarm hat, macht es mit Inulin schlimmer.\n\nSteht nicht auf dem Joghurt.",
      quellen: [],
      related_article: null,
    },
    {
    ...
    },
    {
      ...
      wirkung: "Die AHA stützt sich auf einen Surrogat-Marker. LDL steigt, aber Metaanalysen finden keine konsistente Verbindung zwischen gesättigten Fetten und kardiovaskulärer Mortalität bei gesunden Erwachsenen. Unter Kokosöl steigt vor allem das große, weniger atherogene LDL, HDL steigt im selben Verhältnis. Laurinsäure ist antimikrobiell gegen behüllte Viren, gram-positive Bakterien und Candida, ihr Monoester Monolaurin steht in klinischen Daten.\n\nSonnenblumenöl, das die AHA als Alternative empfiehlt, oxidiert bei Bratenhitze zu reaktiven Aldehyden, die in der Linolsäure-Forschung als gefährlicher gelten als das gesamte gesättigte Fett, gegen das die Warnung sich richtet.\n\nDie Pfanne ist klüger als die Leitlinie, sie raucht beim Sonnenblumenöl und schweigt beim Kokosöl.",
    ...
    },
    {
      ...
      wirkung: "Frisches Kokoswasser ist innerhalb der intakten grünen Schale natürlich steril und stand im Zweiten Weltkrieg als improvisierte Infusion zur Verfügung. Britische Ärzte nutzten es in Sri Lanka, japanische Truppen in Sumatra, in Havanna behandelten Mediziner 1942 zwölf Kinder intravenös ohne dokumentierte Nebenwirkungen. 1954 erhielten in Thailand, den USA und Honduras 157 Patienten Kokoswasser-Infusionen mit klinisch tragbarem Verlauf. Das Elektrolytprofil zeigt hohe Konzentrationen von Kalium, Magnesium und Calcium bei niedrigem Natrium.\n\nDiese Zusammensetzung ähnelt intrazellulärer Flüssigkeit, nicht Plasma. Hinzu kommen Cytokinine als pflanzliche Wachstumshormone mit antioxidativem Profil, Spuren von Laurinsäure und niedrige natürliche Zucker. Die Flüssigkeit ist physiologisch strukturiert, nicht zufällig isoton.\n\nDas eigentliche Produkt ist die frische junge grüne Kokosnuss, geöffnet vor Ort. Pasteurisierte Supermarktware mit hitzedenaturierten Enzymen und oxidierten Phenolen ist ein anderes Profil und teilt mit dem Original wenig mehr als den Namen. Im Zweiten Weltkrieg lief das durch Venen. Heute durch Pappstrohhalme.\n\nDieselbe Flüssigkeit, andere Geschichte.",
    ...
    },
    {
      ...
      wirkung: "Eine Mausstudie aus 2001. Seitdem nichts. Keine Humandaten, keine Fallserie, keine Replikation.\n\nDie Mäuse hatten weniger Blei im Knochenmark, und zwanzig Jahre später verkauft das Internet Koriander als Schwermetall-Chelator. Was existiert. Antimikrobielle Wirkung gegen Salmonellen in vitro, moderate Blutzuckersenkung im Tierversuch.\n\nWas nicht existiert. Irgendetwas, das die Detox-Behauptung trägt.",
      quellen: ["Aga 2001"],
      related_article: null,
    },
    {
    ...
    },
    {
      ...
      wirkung: "D-Limonen ist eines der am besten erforschten Monoterpene mit Daten, die weit über Duft hinausreichen. Wilkins 2002 zeigt in einer offenen Studie bei GERD eine Symptomfreiheit über zwei Wochen bei 89 Prozent der Teilnehmer nach Einnahme von 1000 mg jeden zweiten Tag, ein Effekt, der bisher in keinem Protonenpumpenhemmer-Vergleich seriös nachgeprüft wurde.\n\nIn einer Phase-I-Studie bei Brustkrebs reichern sich Limonen-Metaboliten im Tumorgewebe an und reduzieren die Cyclin-D1-Expression, ein Befund, der präklinisch durch chemopräventive Daten in Kolon-, Haut- und Mammakarzinom-Modellen gestützt wird.\n\nDie Substanz induziert Phase-II-Detoxenzyme wie Glutathion-S-Transferase, was die hepatoprotektive Beobachtung in mehreren Tiermodellen erklärt. Olfaktorisch wirkt sie über limbische Bahnen anxiolytisch und antidepressiv, was die Aromatherapie zufällig richtig macht, ohne den pharmakologischen Hintergrund zu kennen.\n\nEine Zitrusschale wird hier als Putzmittel verkauft, obwohl sie eine Phase-I-Studie hinter sich hat.",
    ...
    },
    {
      ...
      wirkung: "Lithium ist in der Psychiatrie ein nebenwirkungsreiches Antipsychotikum, eingesetzt nur unter engmaschiger Blutspiegelkontrolle. Die therapeutische Breite ist extrem schmal, jede Überschreitung führt in Toxizität. Nephrotoxizität, Schilddrüsensuppression, Tremor und Diabetes insipidus sind dokumentierte Folgen einer Langzeitbehandlung mit 600 bis 1800 mg Lithiumcarbonat. Kein Psychiater verschreibt Lithium ohne wöchentliche Laborkontrolle in der Einstellungsphase. Der Wirkstoff trägt seine Datenlage als Warnetikett, nicht als Versprechen.\n\nWer Lithium kennt, kennt es als Substanz, deren Wirksamkeit ihren Preis fordert, nicht als sanftes Nahrungsergänzungsmittel mit Wohlfühlprofil.\n\nIm Supplement-Markt taucht Lithium seit kurzem als Lithiumorotat in Dosen von 5 bis 20 mg auf, vermarktet als sicheres Mikrodosis-Lithium für Stimmung und Neuroprotektion. Kontrollierte Humanstudien zur Wirksamkeit dieser Dosen existieren nicht.\n\nDie Werbung borgt sich die psychiatrische Datenlage, erhoben bei therapeutischen Dosen, und projiziert sie auf eine zehn- bis hundertfach niedrigere Konzentration ohne jede Dosisbrücke. Das Orotat-Anion soll die Bioverfügbarkeit erhöhen, auch dafür fehlt die belastbare Humanevidenz. Eine Substanz, deren psychiatrischer Einsatz Laborkontrolle erfordert, wird im Biohacker-Kreis als Tagesvitamin angeboten.\n\nDie deutsche Biohacker-Szene reaktiviert Lithium gerade als vergessenes Spurenelement, beruft sich auf ökologische Korrelationsstudien mit Trinkwasser-Lithium und ignoriert, dass dort Mikrogramm-Mengen wirken, nicht Milligramm.\n\nWer 5 mg täglich schluckt, liegt um drei Größenordnungen über dem Trinkwasserwert und um zwei Größenordnungen unter der psychiatrischen Dosis. In dieser Lücke gibt es keine Evidenz, nur Marketing. Das ist Scharlatanerie mit wissenschaftlichem Anstrich.\n\nLithium gehört unter Blutspiegelkontrolle in die Psychiatrie oder ins Trinkwasser, nicht als selbstdosiertes Mikrodosis-Supplement zwischen Vitamin D und Magnesium ins Regal.",
      quellen: ["McKnight 2012", "Schou 1997", "Schrauzer 2002"],
    ...
    },
    {
      ...
      wirkung: "Die peruanische Wurzelknolle wird als »natürliches Aphrodisiakum« vermarktet, ein Anspruch, der sich auf Andentradition und auf eine Handvoll kleiner Studien stützt, deren Methodik und Replizierbarkeit zu wünschen übrig lassen.\n\nEine Untersuchung bei Männern mit erektiler Dysfunktion findet nach zwölf Wochen 2400 mg Maca-Extrakt eine subjektive Verbesserung des sexuellen Wohlbefindens, aber keine objektive Veränderung erektionsphysiologischer Parameter, eine andere bei gesunden Männern keine Wirkung auf Serum-Testosteron, -DHT oder -LH, und die Cochrane-Übersicht 2010 zieht den Schluss, dass die Evidenz für eine echte aphrodisierende Wirkung nicht ausreicht.\n\nMacamide und Glucosinolate sind in vitro pharmakologisch interessant, eine Übersetzung in nachvollziehbare endokrine oder zentralnervöse Effekte am Menschen ist bisher nicht gelungen. Die Andentradition ist real, sie betrifft die ganze frische Knolle in lokaler Zubereitung, nicht ein importiertes Trockenpulver in einer Kapsel.\n\nWer Maca als Hormonbooster nimmt, wirft eine Wurzel ins System, die nachweislich keine Hormone bewegt.",
    ...
    },
    {
      ...
      wirkung: "Macadamia trägt rund achtzig Prozent einfach ungesättigte Fettsäuren, den höchsten MUFA-Anteil aller Nüsse. Entscheidend ist die Palmitoleinsäure, eine Omega-7-Fettsäure in einer Konzentration, die keine andere Nuss erreicht. Palmitoleinsäure wirkt als Lipokin, also als fettabgeleitetes Hormon, das die Glukoseaufnahme im Muskel verbessert und die Glukoseproduktion der Leber drosselt.\n\nDas ist ein eigenständiger metabolischer Wirkmechanismus, kein generischer Effekt »gesunder Fette«. Der Körper reagiert auf eine tägliche Ration mit messbar besserer Insulinantwort. Macadamia gehört in die Schublade hormonell aktives Lebensmittel.\n\nEine Penn-State-Studie aus dem Jahr 2008 zeigt unter täglicher Macadamia-Ration eine Senkung des Gesamtcholesterins um 9,vier Prozent und des LDL um 8,neun Prozent, größer als allein durch den Fettsäureanteil vorhersagbar. Die HOMA-IR-Verbesserung als Insulinresistenz-Marker fällt stärker aus als bei Mandeln oder Walnüssen.\n\nBei regelmäßigem Verzehr sinkt der HbA1c-Wert. Nach dem Rösten steigt der Antioxidantien-Gehalt um 26 Prozent, weil Öl- und Proteinstrukturen aufbrechen und Polyphenole freisetzen. Eine Nuss mit messbarer Wirkung auf Cholesterin, Insulin und Langzeitblutzucker, die im Regal als Knabberei verkauft wird.\n\nBryan Johnson nimmt zehn bis zwölf Macadamianüsse täglich, etwa 28 g, als Kernelement seines Blueprint-Protokolls, eingebaut in den Nutty Pudding, mit Macadamia-Milch als Basis. Die Werbung verkauft hawaiianische Delikatesse, Backzutat, Premium-Snack, Palmitoleinsäure als Lipokin, Insulinsensitivierung und kardiovaskuläre Protektion jenseits des generischen Nuss-Effekts stehen nicht auf der Packung. Im Supermarkt liegt sie zwischen Cashew und Paranuss, im Stoffwechselprofil steht sie allein.\n\nEine pflanzliche Quelle für Omega-7 mit Cholesterin-, Insulin- und Blutzuckerwirkung wird als Geschenkartikel im Glas vermarktet, statt als tägliche Ration in jedem Haushalt.",
      quellen: ["Griel 2008", "Garg 2007", "Curb 2000"],
      related_article: null,
    },
    {
      name: "Magnesium",
    ...
    },
    {
      ...
      wirkung: "Die Rinde enthält Honokiol und Magnolol, zwei Biphenyl-Derivate, die als positive allosterische Modulatoren am GABA-A-Rezeptor an der δ-Untereinheit binden, einem Ort, der mit klassischen Benzodiazepinen nicht überlappt und tonische Hemmung verstärkt, ohne phasische Sedierung zu erzeugen. Die anxiolytische Wirkung in Tiermodellen ist robust und dosisabhängig, in Schlafmodellen reduziert Honokiol die Einschlaflatenz mit einer Wirkstärke vergleichbar Diazepam, ohne dessen Tagesnachwirkung.\n\nDaneben sind beide Substanzen antitumoral durch Apoptose-Induktion und antiinflammatorisch durch NF-κB-Hemmung dokumentiert, ein Spektrum, das in der pharmazeutischen Industrie als Verkaufsargument einer Leitsubstanz gelten würde. Belastbare Humanstudien sind selten und meist herstellergesponsert, was die klinische Bewertung unsicher macht, ohne die präklinische Tiefe zu entwerten.\n\nHonokiol hat das Profil einer pharmakologischen Leitsubstanz und das Marketing einer Teemischung.",
      quellen: [],
      related_article: null,
    },
    {
    ...
    },
    {
      ...
      wirkung: "Silibinin, der pharmakologisch aktive Hauptbestandteil von Silymarin, ist als intravenöses Antidot bei Knollenblätterpilz-Vergiftung (Legalon SIL) eine medizinische Standardsubstanz mit dokumentierter Mortalitätsreduktion in der Behandlung schwerer Amatoxin-Hepatitis.\n\nDiese Wirkung wird in der Werbung beständig zitiert und auf orale OTC-Kapseln übertragen, ohne dass die Dosisbrücke geschlossen wird. Die intravenöse Therapie arbeitet mit etwa 20 mg/kg täglich, entsprechend 1400 mg bei einem 70-kg-Patienten, während handelsübliche Reformhaus-Kapseln 80 bis 140 mg Silymarin pro Dosis liefern, davon nur ein Bruchteil als bioverfügbares Silibinin.\n\nKlinische Studien bei nicht-alkoholischer Steatohepatitis verwenden Dosen ab 420 mg täglich in phytosomaler Form, eine Größenordnung, die im Supplement-Regal selten erreicht wird, weil sie pro Tagesdosis ein halbes Dutzend Kapseln verlangt.\n\nMariendistel ist als Substanz pharmakologisch real.\n\nDas im Regal verkaufte Produkt ist es in der typischen Dosierung kaum.",
    ...
    },
    {
      ...
      wirkung: "Normales Pektin senkt Cholesterin wie Psyllium. Modifiziertes Pektin geht ins Blut und hemmt Galektin-3, ein Protein, das Tumore wachsen lässt. Phase-II-Studie bei Prostatakrebs.\n\nPSA-Verdopplungszeit verlangsamt.",
      quellen: [],
      related_article: null,
    },
    {
    ...
    },
    {
      ...
      wirkung: "Die Mischung Relora kombiniert Magnolia-Rinde mit Phellodendron amurense und wird seit etwa zwanzig Jahren als Cortisol-Modulator vermarktet. Eine zugrundeliegende Berberin-Komponente aus dem Korkbaum hat in vitro plausible Effekte auf den Glukosestoffwechsel, klinische Wirksamkeit auf Cortisol-Tagesprofile findet sich aber ausschließlich in herstellerfinanzierten Studien mit kleinen Fallzahlen, nicht konsistenter Methodik und selektiver Endpunkt-Berichterstattung.\n\nEine unabhängige Replikation der Bauchfett-Reduktion existiert nicht, und die Effekte auf wahrgenommenen Stress liegen in derselben Größenordnung wie Placebo. Die einzelne Wirksamkeit des Phellodendron-Extrakts unabhängig von Magnolia ist klinisch nirgends sauber isoliert.\n\nWas als Cortisol-Senker im Sportregal steht, ist eine Verkaufskonstruktion auf der Basis zweier herstellereigener Studien.",
    ...
    },
    {
      ...
      wirkung: "FDA Health Claim seit 2000. Senkt LDL um sieben bis neun Prozent. Funktioniert bei Verstopfung und bei Durchfall, weil die Faser das Vierzigfache ihres Gewichts an Wasser aufnimmt.\n\nSenkt HbA1c bei Diabetikern.",
      quellen: [],
      related_article: null,
    },
    {
    ...
    },
    {
      ...
      wirkung: "Koch Kartoffeln. Lass sie kalt werden. Iss sie.\n\nDie Stärke wird resistent, der Darm macht Butyrat draus, die Darmschleimhaut heilt. Verbessert nebenbei die Insulinsensitivität. Kein Pulver nötig.\n\nKalte Bratkartoffel schlägt Kapsel.",
      quellen: [],
      related_article: null,
    },
    {
    ...
    },
    {
      ...
      wirkung: "Die Pflanze ist seit den 1960er Jahren im sowjetischen Militär- und Sportprogramm dokumentiert, kam aber erst nach 2000 ins westliche Bewusstsein, mit deutlich weniger Tiefe, als das Datenmaterial hergibt. Hauptwirkstoffe Rosavin und Salidrosid modulieren monoaminerge Systeme über reversible MAO-Hemmung, beeinflussen die HPA-Achse und erhöhen Neuropeptid Y, ein Profil, das in randomisierten Studien bei stressbedingter Erschöpfung und chronischer Burnout-Symptomatik klinisch konsistent abgebildet ist.\n\nEine vierwöchige Studie bei moderater Depression zeigt nach 340 mg täglich signifikante Symptomreduktion auf der Hamilton-Skala, in der Größenordnung mit Sertralin vergleichbar, aber mit besserem Nebenwirkungsprofil.\n\nDie Werbung verkauft das Adaptogen als »Stress-Hilfe«, was die anxiolytische, antidepressive und kognitiv stimulierende Wirkung auf einen einzigen Nenner reduziert, der nichts erklärt. Eine Pflanze, die in einer direkten Studie mit Sertralin mithält, wird im Reformhaus nicht als Antidepressivum verkauft.\n\nSie wird als Wachmacher etikettiert, weil das einfacher ist.",
    ...
    },
    {
      ...
      wirkung: "Tulasi gilt im Ayurveda als »Rasayana«, eine Pflanze, die in den klassischen Texten gegen so unterschiedliche Beschwerden wie Husten, Fieber, Schlangenbisse und seelische Verstimmung empfohlen wird, eine Indikationsliste, die nach Folklore klingt und sich bei näherer Betrachtung pharmakologisch in einzelne Wirkachsen auflösen lässt. Hauptwirkstoffe sind Eugenol, Ursolsäure und Carvacrol, mit anxiolytischen und adaptogenen Effekten über Cortisol-Modulation in einer randomisierten Studie an erwachsenen Probanden mit Stress-Symptomen.\n\nEine weitere Studie bei Typ-2-Diabetes zeigt nach acht Wochen 2,5 g Blattpulver täglich signifikante Senkung des Nüchternblutzuckers und postprandialer Glukose, eine indische Kardiologie-Studie eine Senkung von Gesamtcholesterin und Triglyceriden über vier Wochen. Antimikrobiell wirkt das ätherische Öl breit gegen grampositive Bakterien und Pilze, in vitro mit Wirkstärke vergleichbar zu Gentamicin in standardisierten Verdünnungsversuchen.\n\nDie Werbung verkauft die Pflanze als »Königin der Kräuter«, ein Etikett, das pathetisch klingt und im pharmakologischen Befund tatsächlich nicht weit von der Realität liegt.\n\nSelten ist das so, und vermutlich liegt es daran, dass die Pflanze in Indien als Gottheit gilt und das Marketing keine Verkleinerung wagt.",
    ...
    },
    {
      ...
      wirkung: "Retinol ist die direkt aktive Form, ohne Konversionsschritt. Beta-Carotin muss erst über das Enzym BCO1 zu Retinol umgebaut werden. Bei häufigen Genvarianten von BCO1 läuft diese Umwandlung schwach. Wer mit pflanzlichem Provitamin A versorgen will und die falsche Genetik hat, bleibt im Mangel. Im Gegensatz zu Beta-Carotin trägt Retinol eine harte Dosisgrenze. Über 10000 IU täglich werden hepatotoxisch, in der Schwangerschaft teratogen.\n\nRetinol steuert Sehfunktion am Stäbchen, Epithelintegrität an Haut und Schleimhaut und die Immunantwort an T-Zellen. Lebertran lieferte das historisch in der Skandinavien-Diät der Fischer.\n\nWer auf Karotten setzt und Konvertierungsprobleme hat, supplementiert besser direkt.\n\nRetinol ist Pharmakologie mit Sicherheitsgurt, nicht Wellness-Vitamin.",
    ...
    },
    {
      ...
      wirkung: "Pantothensäure ist die Vorstufe von Coenzym A, dem zentralen Träger von Acetyl- und Acylresten im Stoffwechsel. Ohne CoA stoppt die Fettsäuresynthese, die Acetylcholin-Bildung und die Produktion von Cortisol, Aldosteron und Geschlechtshormonen. Knotenpunkt der Acetyl-Biochemie.\n\nDexpanthenol als Vorstufe in der topischen Anwendung beschleunigt die epitheliale Reepithelisierung nach Verbrennungen, Operationen und Schleimhautläsionen. Daten in Dermatologie und HNO sind solide. Akne-Studien mit oraler Megadosis kursieren seit Jahren, methodisch dünn, schlecht verblindet, Effektstärke fraglich. Klinischer Mangel ist selten und entsteht meist im Rahmen genereller Mangelernährung. Müdigkeit, Brennen in den Füßen und Kopfschmerzen gelten als Frühzeichen. topisch sauber belegt, oral als Beauty-Mittel überverkauft.\n\nKaffee blockiert die Aufnahme der B-Vitamine um bis zu achtzig Prozent. Wer Pantothensäure einnimmt, um nach durchwachten Nächten und vier Tassen Filterkaffee die Haut zu retten, behandelt die falsche Stellschraube. Pantothensäure ist solide, aber kein Wundermittel.\n\nin der Wundsalbe gerechtfertigt, im Anti-Aging-Sortiment Marketing.",
      quellen: ["Morck 1983", "Rapuri 2007", "Ebner 2002", "Leung 1995"],
      related_article: null,
    },
    {
      name: "Vitamin B6 (P5P)",
