...
window.SUBSTANCES_DATA = {
  entries: [
    ...
    },
    {
      ...
      wirkung: "Skorbut verhindern ist die Pflichtfunktion. Was Vitamin C oberhalb der Skorbut-Schwelle leistet, ist eine andere Substanz. Pharmakologisch ist es Cofaktor für Prolyl- und Lysyl-Hydroxylase, die Enzyme, ohne die kein Kollagen vernetzt wird. Bindegewebe steht und fällt mit Vitamin C, und Knochen sind zur Hälfte aus Kollagen Typ I gemacht, nicht aus Calcium allein.\n\nWer Osteopenie hat, bekommt vom Endokrinologen Bisphosphonate verschrieben, die die Knochenresorption blockieren, ohne neuen Aufbau zu fördern. Vitamin C macht das Gegenteil. Es aktiviert die Osteoblastogenese über Wnt/β-Catenin/ATF4-Signaling und drosselt parallel die Osteoclastogenese. Im ovariektomierten Rattenmodell stellt es die Knochendichte messbar wieder her. Die humanen Beobachtungsstudien fallen heterogen aus, weil sie an Aufnahmemengen knapp über Skorbut-Niveau messen und nicht an pharmakologischen Dosen. Wer den eigenen Knochen erhalten will, dosiert nicht für Skorbutfreiheit.\n\nIntravenös wird Vitamin C zum Pharmakon. In Dosen von 12 bis 100 Gramm pro Infusion erreicht es millimolare Plasmaspiegel, die oral physiologisch unerreichbar bleiben, weil der Magen-Darm-Trakt bei etwa zwei Gramm sättigt. In dieser Konzentration wirkt es pro-oxidativ, generiert reaktive Sauerstoffspezies selektiv in Tumorzellen, lässt Normalzellen unbehelligt und aktiviert TET-Enzyme zur epigenetischen Reprogrammierung. Das NCI-Review 2024 dokumentiert konsistente präklinische Antitumorwirkung an Pankreas-, Prostata-, Ovarial- und Kolorektalkarzinom, Phase-II-Studien zeigen synergistische Effekte in Kombination mit Standardchemotherapie und reduzieren deren Nebenwirkungen.\n\nBei Sepsis ist die Lage komplizierter. Die LOVIT-Studie 2022 brachte die Hochdosis-Monotherapie in Verruf mit schlechteren Outcomes, spätere Reanalysen 2024 deuten an, dass die fixe Niedrigdosis-Strategie nach Marik das Problem war, nicht der Stoff. Bei dokumentiertem Vitamin-C-Mangel im Plasma und schwerem septischem Verlauf bleibt der Nutzen umstritten und in laufenden Studien (CEMVIS, 12 g alle 12 Stunden) offen.\n\nDie liposomale Form erreicht 1,7 bis 3,3-fach höhere Plasmaspiegel als Pulver-Ascorbinsäure. Frisch aus Zitronen gepresst ist chemisch dieselbe Ascorbinsäure, aber begleitet von Hesperidin, Rutin, Quercetin und weiteren Bioflavonoiden, die Aufnahme und Gefäßwirkung verstärken und in keiner Dose nachgebildet werden. Pulver aus dem Beutel ist Notlösung, der Saft aus der Frucht ist Therapie.\n\nLinus Pauling hat die Megadosen-Idee proklamiert, bevor die Pharmakokinetik verstanden war. Die Studien, die ihn widerlegen sollten, haben oral getestet, was nur intravenös funktioniert. Vier Jahrzehnte später zeigt die Pharmakologie, dass er nicht falsch lag, sondern den falschen Verabreichungsweg empfahl. Der Pauling-Mythos ist halb entlarvt und halb rehabilitiert, und das macht Vitamin C zur typischen Substanz dieses Index, an deren Marginalisierung Industrie und Konsens gleichermaßen verdient haben.",
