...
Die Angriffe auf Rettungskräfte in der Silvesternacht 2025/26 gehen über die quantitative Steigerung eines bekannten Phänomens hinaus. Was sich in Frankfurt, Berlin, Duisburg und Leipzig ereignete, dokumentiert einen qualitativen Strukturbruch. Einsatzkräfte wurden gerade wegen ihrer Schutzfunktion angegriffen, und die Mittel ihrer Bekämpfung erzwangen den Einsatz militärisch konnotierter Gerätschaft, um zivile Grundversorgung aufrechtzuerhalten.

In Frankfurt wurde ein Rettungswagen auf einer Einsatzfahrt von einer größeren Gruppe attackiert, mit Pyrotechnik beschossen und blockiert; ein Sanitäter wurde getreten. Unmittelbar danach riss dieselbe Gruppe die Behandlungstür des Fahrzeugs auf und deponierte eine bewusstlose Frau im Innenraum. Diese Sequenz (Angriff auf das Rettungsmittel, dann dessen erzwungene Nutzung) wirkt widersprüchlich, beschreibt aber eine Gleichzeitigkeit, die in der bisherigen Phänomenologie ohne Vorbild ist. Der Rettungswagen wird zum Objekt simultaner Zerstörung und Beanspruchung. In einem zweiten Frankfurter Vorfall blockierte eine Straßensperre einen Rettungswagen auf dem Weg zur Klinik. Die Polizei musste einen Räumpanzer einsetzen, um die Zufahrt freizumachen.

In Berlin-Moabit eskalierten Angriffe auf eine Polizeistreife zu einer Konfrontation mit etwa 500 Personen. Die Intensität des Pyrotechnik-Beschusses machte einen Feuerwehreinsatz unmöglich, sodass ein Wasserwerfer die Löscharbeit der Feuerwehr übernehmen musste. Der Wasserwerfer, konstruiert zur Auflösung von Menschenansammlungen, substituiert das Löschfahrzeug. Dieser Gerätewechsel komprimiert die Verschiebung des Einsatzkontexts vom Zivilen ins Paramilitärische. In Duisburg-Hamborn wurde ein Feuerwehrmann gezielt mit einem Feuerwerkskörper auf Kopfhöhe beschossen. In Leipzig-Connewitz errichteten Gruppen brennende Barrikaden und attackierten systematisch Feuerwehr und Polizei.

Was die Silvesternacht 2025/26 strukturell neu macht, ist die Funktionssubstitution. Wenn die Feuerwehr nicht löschen kann und ein Wasserwerfer ihre Aufgabe übernimmt, wenn ein Räumpanzer den Rettungsdienst befreit, dann haben Rettungskräfte den zivilen Raum verlassen und operieren in einer Umgebung, die den Einsatzparametern einer Konfliktsituation entspricht. Die Eskalationslogik ist kategorial; sie folgt keiner linearen Steigerung (mehr Böller, mehr Aggression). Die zivile Einsatzinfrastruktur reicht nicht mehr aus, um zivile Grundfunktionen zu erfüllen.

Die Multilokalität verstärkt die Diagnose. Vier Großstädte in einer einzigen Nacht beschreiben ein überregionales Muster, das sich am Fixdatum der Silvesternacht zuverlässig reproduziert. Die Jahreszyklizität schafft eine Planbarkeit, die Prävention theoretisch ermöglichen müsste. Dass sie praktisch scheitert, offenlegt die Dimension des Problems.

Ein Wasserwerfer, der Brände löscht, weil die Feuerwehr unter Beschuss steht, ist das Symptom einer Ordnung, die an ihrem eigenen Schutzversprechen scheitert.
